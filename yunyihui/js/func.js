...
(function ($) {	
	...
	if(pgTyp == 'idx') {
		...
		$(window).scroll(function () {
			$abotRegionTit.each(function () {
				...
				var $fwmsTit = $('#fwmsTit');
				if(scrollY > $fwmsTit.offset().top - 300) { $('.abot-nav-it-on').removeClass('abot-nav-it-on');}
			});
		});
	}
	else if (pgTyp == 'prod') {
    ...
    //标注点数组
    var markerArr = [{title:"河南金品实业有限公司",content:"河南省郑州市商务内环西二街伟业财智广场13C",point:"113.726376|34.779093",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    //创建marker
    function addMarker(){
